...
def Contig_start(chr_num,cut_threshold,ref_dir,out_dir,phase_cut_folder,xin):
    ...
    contig_fasta_file = out_dir + "XinMagic_cutPBHC_minicontig_chr" + str(chr_num) + ".fasta"
    contig_sam_file = out_dir + "XinMagic_cutPBHC_minicontig_chr" + str(chr_num) + ".sam"
    ref_fasta_file = ref_dir + "ref_seq_chr" + str(chr_num) + ".p"
    ref_fasta_dict = pickle.load(open(ref_fasta_file,"rb"))
    output_file = out_dir + "XinMagic_Contig_chr" + str(chr_num) + ".fasta"
