...
if __name__ == "__main__":
    ...
    for chr_num in range(chr_start,chr_end + 1):
        ...
        SV_dict_contig_1 = Extract_SV_info(out_dir + "Aquila_Contig_chr" + str(chr_num) + "_hp1.var.txt",out_dir + "ins_dict_contig_1_chr" + str(chr_num) + ".p", chr_num)
        SV_dict_contig_2 = Extract_SV_info(out_dir + "Aquila_Contig_chr" + str(chr_num) + "_hp2.var.txt",out_dir + "ins_dict_contig_2_chr" + str(chr_num) + ".p", chr_num)
