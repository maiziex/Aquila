...
def Get_fragment_files(bam_file,vcf_file,chr_start,chr_end,h5_dir,num_threads,mbq,boundary,sample_name):
    ...
    use_cmd = "python3 " + code_path + "Run_h5_all_multithreads_GenRef.py" + " --bam_file " + bam_file + " --vcf_file " + vcf_file + " --sample_name " + sample_name + " --chr_start " + str(chr_start) + " --chr_end " + str(chr_end) + " --mbq " + str(mbq) + "  --mmq 0  --boundary " + str(boundary) + " --num_threads " + str(num_threads) + " --out_dir " + h5_dir
...
def Haplotying_fragments(chr_start,chr_end,phased_file_dir,h5_dir,sample_name):
    ...
    use_cmd = "python3 " + code_path + "Run_phase_alg_multithreads2_GenRef.py" + " --chr_start " + str(chr_start) + " --chr_end " + str(chr_end) + " --overlap_threshold 3 --support_threshold 5 " + " --out_dir " + phased_file_dir  + " --h5_dir " + h5_dir + " --sample_name " + sample_name
    Popen(use_cmd,shell=True).wait()
