...
def read_phase_block_file(pickle_file,h5_file,output_file,metric_phase_percent,metric_corr_percent):
    ...
    Assign_phase_block(phase_block_2,h5_file,output_file,metric_phase_percent,metric_corr_percent)
